    ...
    <section class="inner-page">
      <div class="container">
        ...
        <p>Please enter the job details</p>
			<sf:form method="POST" action="addJob" modelAttribute="bindJob">
			<sf:label path="title">Job Title: </sf:label>
			<p><sf:input type="text" path="title" id="jobTitle" required="true"/></p>
			<sf:label path="type">Job Type: </sf:label>
			<p><sf:input type="text" path="type" id="jobType" required="true"/></p>
			<p><input type="submit" value="Submit Job Details" /></p>
			</sf:form>
        </p>
      </div>
    </section>
