  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <c:if test="${not empty sessionScope.currentJob}">
          <h2>${requestScope.currentJob.title}</h2>
          </c:if>
          <c:if test="${empty sessionScope.currentJob}">
          <h2>Display Job</h2>
          </c:if>
          <ol>
            <li><a href="home">Home</a></li>
    ...
    <section class="inner-page">
      <div class="container">
        <p>
        <c:if test="${not empty sessionScope.currentJob}">
		<p>Job Type: ${sessionScope.currentJob.type}</p>
		<p>Average Pay: ${sessionScope.currentJob.avgPay}</p>
	</c:if>
	<c:if test="${empty sessionScope.currentJob}">
		<p><a href="addJob">Job not found, click here to add job</a></p>
	</c:if>
        </p>
      </div>
    </section>
