...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
        <sf:form method="POST" action="processUser" modelAttribute="bindUser">
		<sf:label path="username">Username: </sf:label>
		<p><sf:input type="text" path="username" id="userUsername" required="true"/></p>
		<sf:label path="fName">First Name: </sf:label>
		<p><sf:input type="text" path="fName" id="userFName" required="true"/></p>
		<sf:label path="lName">Last Name: </sf:label>
		<p><sf:input type="text" path="lName" id="userLName" required="true"/></p>
		<sf:label path="password">Password: </sf:label>
		<p><sf:input type="password" path="password" id="userPassword" required="true"/></p>
		<sf:label path="email">Email: </sf:label>
		<p><sf:input type="email" path="email" id="userEmail" required="true"/></p>
		<p><input type="submit" value="Submit User Details" /></p>
	</sf:form>
        </p>
      </div>
    </section>
