...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
        <sf:form method="POST" action="processReview" modelAttribute="bindReview">
		<sf:label path="comment">Comment: </sf:label>
		<p><sf:input type="text" path="comment" id="reviewComment" required="true"/></p>
		<sf:label path="payRate">Pay Rate: </sf:label>
		<p><sf:input type="number" path="payRate" id="reviewPayRate" required="true"/></p>
		<sf:label path="accommodationType">Accommodation Type: </sf:label>
		<p><sf:input type="text" path="accommodationType" id="reviewAccommodationType" required="true"/></p>
		<sf:label path="accommodationCost">Accommodation Cost: </sf:label>
		<p><sf:input type="number" path="accommodationCost" id="reviewAccommodationCost" required="true"/></p>
