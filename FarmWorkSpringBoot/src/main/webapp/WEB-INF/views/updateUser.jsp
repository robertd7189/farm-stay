  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="inner-page">
      <div class="container">
		...
		<p><input type = "text" name = "newUserUsername" id = "username" required="true"></p>
		<label for = "password">Password: </label>
		<p><input type = "password" name = "newUserPassword" id = "password" required="true"></p>
		<p><input type = "submit" value = "Submit New Username and Password"></p>
	</form>
        </p>
      </div>
    </section>
