  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="inner-page">
      <div class="container">
		...
		<p><input type = "text" name = "userUsername" id = "username" required="true"></p>
		<label for = "password">Password: </label>
		<p><input type = "password" name = "userPassword" id = "password" required="true"></p>
		<p><input type = "submit" value = "Submit Login Details"></p>
	</form>
        </p>
      </div>
    </section>
