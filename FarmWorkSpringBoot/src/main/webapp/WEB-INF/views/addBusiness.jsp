...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <section class="inner-page">
      <div class="container">
        <p>
        <sf:form method="POST" action="addBusiness" modelAttribute="bindBusiness">
		<sf:label path="name">Business Name: </sf:label>
		<p><sf:input type="text" path="name" id="businessName" required="true"/></p>
		<sf:label path="location">Location: </sf:label>
		<p><sf:input type="text" path="location" id="businessLocation" required="true"/></p>
		<p><input type="submit" value="Submit Business Details" /></p>
		</sf:form>
        </p>
      </div>
    </section>
